...
URL = "https://github.com/mikejgray/skill-meal-plan"
SKILL_CLAZZ = "MealPlanSkill"  # needs to match __init__.py class name
PYPI_NAME = "meal-plan-skill"  # pip install PYPI_NAME
...
setup(
    ...
    extras={"test": get_requirements("requirements/requirements-dev.txt")},
)

...
def get_skill_json(skill_dir: str, lang_code: str = "en-us"):
    ...
    skill_json = join(skill_dir, f"skill_meal_plan/locale/{lang_code}/skill.json")
...
def get_skill_data(skill_dir: str, lang_code: str = "en-us"):
    skill_data = {
        "skill_id": "skill_meal_plan.oscillatelabsllc",
        "source": "https://github.com/oscillatelabsllc/skill-meal-plan",
        "package_name": "skill-meal-plan",
        "pip_spec": "skill-meal-plan",
        "license": "Apache-2.0",
        "author": ["Oscillate Labs <mike@oscillatelabs.net>"],
        "icon": "https://raw.githack.com/FortAwesome/Font-Awesome/master/svgs/solid/utensils.svg",
        "images": [],
        "name": "skill-meal-plan",
        "description": "An OVOS voice skill for meal suggestions",
        "examples": [],
        "tags": ["ovos", "neon", "meal", "planning"],
        "version": "",
    }
    ...
    locale_skill_json = join(skill_dir, f"skill_meal_plan/locale/{lang_code}/skill.json")
...
if __name__ == "__main__":
    ...
    copy(f"{argv[1]}/skill_meal_plan/locale/en-us/skill.json", f"{argv[1]}/skill.json")
